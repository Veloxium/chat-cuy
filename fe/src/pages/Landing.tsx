      ...
      <IndexLayout>
         ...
         <div className="min-h-screen h-full py-10 flex items-center justify-center">
            <motion.div
               ...
               className={`bg-white text-zprimary border border-zprimary flex flex-col items-center justify-center py-8 px-4 w-full rounded-lg ease-in-out duration-300 ${isNewUser ? "max-w-4xl" : "max-w-lg"
                  }`}
            >
               ...
               <a
                  ...
                  className={`mt-4 flex items-center text-xs gap-1 hover:underline justify-end w-full ease-in-out duration-300 ${isNewUser ? "max-w-3xl" : "max-w-lg"
                     }`}
               >
                  <p>Our Repository</p>
